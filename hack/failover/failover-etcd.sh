...
BENCH_DURATION_SECS="${CHRONOS_FAILOVER_BENCH_DURATION_SECS:-60}"
BENCH_WARMUP_SECS="${CHRONOS_FAILOVER_BENCH_WARMUP_SECS:-10}"
ALLOCATE_SUCCESS_PER_SEC_MIN="${CHRONOS_FAILOVER_ALLOCATE_SUCCESS_PER_SEC_MIN:-10}"
