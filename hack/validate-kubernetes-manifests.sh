...
data = config.fetch("data", {})
{
  ...
  "CHRONOS_CLUSTER_FORMAT_VERSION" => "3",
  "CHRONOS_TSO_EPOCH_UNIX_MS" => "1767225600000",
  "CHRONOS_TSO_PHYSICAL_BITS" => "40",
  "CHRONOS_TSO_GENERATOR_BITS" => "13",
  "CHRONOS_TSO_SEQUENCE_BITS" => "11",
  "CHRONOS_SHARED_GENERATORS" => "128",
  "CHRONOS_WARM_GENERATORS" => "128",
