...
SOAK_DURATION_SECS="${CHRONOS_SOAK_DURATION_SECS:-3600}"
SOAK_WARMUP_SECS="${CHRONOS_SOAK_WARMUP_SECS:-60}"
DEFAULT_CONTROL_DURATION_SECS=300
if [[ -n "${CHRONOS_SOAK_DURATION_SECS:-}" ]]; then
  DEFAULT_CONTROL_DURATION_SECS="${SOAK_DURATION_SECS}"
fi
CONTROL_DURATION_SECS="${CHRONOS_SOAK_CONTROL_DURATION_SECS:-${DEFAULT_CONTROL_DURATION_SECS}}"
FILTERED_DURATION_SECS="${CHRONOS_SOAK_FILTERED_DURATION_SECS:-${DEFAULT_CONTROL_DURATION_SECS}}"
...
SAFETY_GAP_MS="${CHRONOS_SOAK_SAFETY_GAP_MS:-500}"
...
control_duration_secs=${CONTROL_DURATION_SECS}
filtered_duration_secs=${FILTERED_DURATION_SECS}
...
env \
  ...
  CHRONOS_CONTROL_BENCH_DURATION_SECS="${CONTROL_DURATION_SECS}" \
...
env \
  ...
  CHRONOS_CONTROL_BENCH_TIMELINES="${CONTROL_TIMELINES}" \
  CHRONOS_CONTROL_BENCH_PAGE_SIZE="${CONTROL_PAGE_SIZE}" \
  CHRONOS_CONTROL_BENCH_DURATION_SECS="${FILTERED_DURATION_SECS}" \
  CHRONOS_CONTROL_BENCH_WARMUP_SECS="${SOAK_WARMUP_SECS}" \
