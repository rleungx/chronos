...
required_layer4_tests=(
  ...
  etcd_cluster_format_initialization_persists_and_enforces_timestamp_layout
  etcd_cluster_format_v2_migrates_only_to_the_default_timestamp_layout
  etcd_custom_timestamp_layout_rejects_markerless_existing_timestamp_data
